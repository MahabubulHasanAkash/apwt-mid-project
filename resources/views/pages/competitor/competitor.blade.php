    ...
    <div class="row pl-3 pr-3">
        <div class="col-md-2 side-bar">
            ...
            <div class="nav flex-column nav-pills" aria-orientation="vertical">
                ...
                <a class="link active" href="/product">Product</a>
                <a class="link" href="/sales">Sales</a>
                <a class="link" href="/inventory">Inventory</a>
                <a class="link" href="/demands">Demand</a>

                <div class="pt-3 pt-2 pb-2">Outliner</div>
                <a class="link" href="/contact">Tag Outliner</a>

                <div class="pt-3 pt-2 pb-2">Compare</div>
                <a class="link" href="/competitor">Compare with Competitor</a>

                <div class="pt-3 pb-2">Report</div>
                <a class="link" href="/breakdown">Product Breakdown</a>
                <a class="link" href="/sales_report">Sales</a>
                <a class="link" href="#v-pills-messages">Mail Report</a>

                <div class="pt-3 pb-2">General</div>
                <a class="link" href="/members/list">Members</a>
                <a class="link" href="/members/create">Add Members</a>
                <a class="link" href="/contact">Connect with admin</a>
